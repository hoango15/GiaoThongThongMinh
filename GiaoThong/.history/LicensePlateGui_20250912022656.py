...
class EntryWindow(tk.Toplevel):
    ...
    # ================== STOP EVENT CONTROL ==================
    def reset_stop(self):
        """Tạo stop_event mới để dừng thread"""
        self.stop_event = threading.Event()

    def request_stop(self):
        """Đặt cờ stop_event để báo dừng"""
    ...
    def confirm_save(self):
        ...
        try:
            insert_vehicle(self.detected_plate, ticket_code,
                           self.detected_vehicle_img, self.detected_plate_img, vehicle_type)
